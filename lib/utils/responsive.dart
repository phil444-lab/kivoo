...
class Responsive {
  ...
  static double fontSize(BuildContext context, double baseFontSize) => baseFontSize * getScaleFactor(context);

  /// Adapte une taille d'icône selon l'écran
  static double iconSize(BuildContext context, double baseIconSize) => baseIconSize * getScaleFactor(context);

  /// Adapte un padding selon l'écran
  static double padding(BuildContext context, double basePadding) => basePadding * getScaleFactor(context);

  /// Adapte une dimension selon l'écran
  static double dimension(BuildContext context, double baseDimension) => baseDimension * getScaleFactor(context);
}